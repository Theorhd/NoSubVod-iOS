    ...
    Ok(Json(
        state
            ...
            .update_settings(
                ...
                patch.desktop_pairing_enabled,
                patch.desktop_pairing_server_url,
                patch.desktop_pairing_server_token,
                patch.desktop_pairing_device_id,
                patch.desktop_pairing_apns_token,
                patch.desktop_pairing_push_override,
